...
const Banner = () => {
  ...
  return (
    <div className="">
      <div class="hero lg:py-32 sm:py-6 bg-base-200">
  <div class="hero-content flex-col lg:flex-row ">
    <img src="https://i.ibb.co/Zzg7PcV/banner1jpg-sizing1.jpg" class="lg:max-w-lg lg:p-12 sm:p-2 rounded-lg shadow-2xl" />
    <div className="px-12">
